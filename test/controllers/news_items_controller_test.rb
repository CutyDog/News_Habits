...
class NewsItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post news_items_url, params: { news_item: { description: @news_item.description, link: @news_item.link, news_site_id: @news_item.news_site_id, published_at: @news_item.published_at, title: @news_item.title } }
    end
  ...
  test "should update news_item" do
    patch news_item_url(@news_item), params: { news_item: { description: @news_item.description, link: @news_item.link, news_site_id: @news_item.news_site_id, published_at: @news_item.published_at, title: @news_item.title } }
